...
data "aws_iam_policy_document" "write" {
  statement {
    ...
    resources = [
      aws_ecr_repository.interop.arn
    ]
  }
}
...
resource "aws_ecr_repository" "interop" {
  name = "${var.namespace}/interop"
...
resource "aws_ecr_lifecycle_policy" "interop_policy" {
  repository = aws_ecr_repository.interop.name
